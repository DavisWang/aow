...
- Units  
  - There are 3 basic types of units for each age, melee, ranged, and mega. Units march in a single file line automatically towards the enemy base after being built.  
...
| **Ranged (ranged attack)** | Stonethrower | Archer | Cannoneer | Machine Gunner |  |
| **Mega (melee)** | Dino Rider | Knight |  | Tank |  |
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| **Super** | Meteor Shower | Rain of Arrows |  | Carpet Bomb | Lazer cannon |
...
| Age | Prehistoric | Medieval | Renaissance | Modern | Future |
| :---- | :---- | :---- | :---- | :---- | :---- |
| Tower A | Stone  | Arrow tower |  |  |  |
| Tower B |  |  |  |  |  |
| Tower C |  |  |  | Missle | Ion blaster |
...
- Base  
  ...
  - Bases   
- Map  
  - There is a single map that is side scrollable and stops scrolling once either the player or the enemy’s base comes into full view. The user drags their mouse towards left edge to scroll the camera view left, and same for right.  
- Money  
...
- TODO later, use dropin assets for now for units, super, bases, towers  
